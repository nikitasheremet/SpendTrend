...
export const VALIDATION_ERROR_NAME_MUST_BE_NOT_EMPTY = 'Name must not be empty'
...
export const VALIDATION_ERROR_USERID_MUST_NOT_BE_EMPTY = 'User ID must not be empty'
