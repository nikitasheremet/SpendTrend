...
import { updateExpenseCategoryResponseToDomainExpenseCategory } from '../updateExpenseCategoryResponseToDomainExpenseCategory'
...
describe('updateExpenseCategoryResponseToDomainExpenseCategory', () => {
  describe('when given a valid contract expense category', () => {
    it('should map all fields correctly', () => {
      ...
      const result = updateExpenseCategoryResponseToDomainExpenseCategory(fakeInput)
  ...
  describe('when given an invalid expense category', () => {
    it('should throw an error', () => {
      ...
      expect(() => updateExpenseCategoryResponseToDomainExpenseCategory(fakeInvalidInput)).toThrow()
    })
  })
})
