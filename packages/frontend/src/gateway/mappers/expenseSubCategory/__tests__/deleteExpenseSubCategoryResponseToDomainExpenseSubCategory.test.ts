...
import { deleteExpenseSubCategoryResponseToDomainExpenseSubCategory } from '../deleteExpenseSubCategoryResponseToDomainExpenseSubCategory'
...
describe('deleteExpenseSubCategoryResponseToDomainExpenseSubCategory', () => {
  describe('when given a valid contract expense subcategory', () => {
    it('should map all fields correctly', () => {
      ...
      const result = deleteExpenseSubCategoryResponseToDomainExpenseSubCategory(fakeInput)
  ...
  describe('when given an invalid expense subcategory', () => {
    it('should throw an error', () => {
      ...
      expect(() =>
        deleteExpenseSubCategoryResponseToDomainExpenseSubCategory(fakeInvalidInput),
      ).toThrow()
    })
  })
})
